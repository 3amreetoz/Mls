    ...
    //*************************************  Section for the payment method  *************************************//
    //echo '<br><b><font size="5">Price:</font> <font color="red" size="5px">'.$course->price.'</font></b>'.'<a href="newtet.php?$usrid='.$getusrid.'&courseid='.$getcourse.'"><img src="buynow.png"></a>';

    if($course->price >= 0.01 && !isguestuser()){
        echo '<br><b><font size="5">Price:</font> <font color="red" size="5px">'.$course->price. $getcountry .'</font></b>';
    echo '<form name="redirectpost" method="post" action="http://dev-inv.com" >
            <input type="hidden" name="ID" value="'.$getusrid.'">
            <input type="hidden" name="courseid" value="'.$getcourse.'">
            <input type="hidden" name="Price" value="'.$getprice.'">
            <input type="hidden" name="Currency" value="'.$getcurrency.'">
            <input type="hidden" name="First_Name" value="'.$getfirstname.'">
            <input type="hidden" name="Last_Name" value="'.$getlastname.'">
        ...
        // var_dump($data);die();  
        try {
            $insertedid = $DB->insert_record('payment_status', $data);
            if ($insertedid) {
